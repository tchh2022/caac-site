...
d = d.replace("\u5218\u9e4f\u98de</div>", "\u5218\u9e4f\u98de</div>" + new, 1)

# 3. Clear slider-controls
d = re.sub(r'<div class="slider-controls">\s*?<button.*?</div>', '<div class="slider-controls">', d, flags=re.DOTALL)

# Write with explicit flush
with open(p, "w", encoding="utf-8") as f:
    f.write(d)
print("OK - teacher cards:", d.count("teacher-card"))
