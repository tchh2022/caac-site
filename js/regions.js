...
function updateCities(t) {
  ...
  var c = form.querySelector('select[name="city"]');
  var d = form.querySelector('select[name="district"]');
...
function updateDistricts(t) {
  var cVal = t.value;
  var form = t.closest('form');
  var pSel = form.querySelector('select[name="province"]');
  var d = form.querySelector('select[name="district"]');
  d.innerHTML = '<option value="">-- 请选择区 --</option>';
  if (!cVal || !pSel.value || !R[pSel.value]) return;
  var districts = R[pSel.value][cVal];
  if (!districts) return;
